...
def test_founding_2pop():
    """
    Checks that the migration matrix generated by the `ParametrizedDemography` model for a two-population founding event matches the expected migration matrix based on the old model's parameters.
    """
