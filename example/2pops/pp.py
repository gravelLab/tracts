...
def pp((init_Eu,tstart)):       
        ...
        if  tstart<0:
                #time shouldn't be negative: that should be caught by constraint. Return empty matrix
...
#now define the same model, but fixing the ancestry proportion using the known total ancestry proportions "frac"        
