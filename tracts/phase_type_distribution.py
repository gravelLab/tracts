...
class PhaseTypeDistribution(ABC):
    ...
    def PhT_CDF_windowed(self, S, alpha, S0_inv, bins: npt.ArrayLike, L: float, s1: float, pop_number: int,
        ...
        The PhT parameters (initial state, transition matrix) are taken from a PhTMonoecious or
        PhTDioecious object (together with the specification of a population of interest) but also directly
        introduced as an input.
    ...
    def tractlength_histogram_windowed(self, population_number: int, bins: npt.ArrayLike, L: float,
        ...
        exp_Sx_per_bin_f: npt.ArrayLike
        exp_Sx_per_bin_m: npt.ArrayLike
    ...
    def inner_CDF(self, x, L, S, exp_Sx=None, alpha=None, S0_inv=None):
        """ Calculates the CDF of tractlengths on a window L.
