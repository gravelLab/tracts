...
class ParametrizedDemographyMultiPop(BaseParametrizedDemography):
    """
    ...
    def load_from_YAML(filepath: str | Path) -> ParametrizedDemographyMultiPop:
        ...
        """
        demography = ParametrizedDemographyMultiPop('Unnamed Model')
        ...
        with open(filepath) as file, ruamel.yaml.YAML(typ="safe") as yaml:
            ...
            for population in demes_data['demes']:
                if 'ancestors' in population:
                    ...
                    source_populations, remainder_population = ParametrizedDemographyMultiPop.parse_proportions(
