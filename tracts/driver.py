...
def run_tracts(driver_filename: str, script_dir: str):
    ...
    try:
        ...
        # Time parameters need to be rescaled for some optimizers; these always rescale via
        # parameter_handler before computing migration matrices / violation scores.
        ...
        def _run_stage(start_params: list, two_steps_optimization: bool, start_params_title:str=None,
            ...
            over all of ``start_params``, sharing the setup common to every stage of
            this run (``genetic_model``, ``pop``, population/iteration/verbosity settings).
            """
...
def run_model_multi_init(genetic_model: GeneticModel, population: Population,
                        ...
                        print_start_params_table: bool = True) -> tuple[list[np.ndarray], list[float], list[float | None]]:
    """
